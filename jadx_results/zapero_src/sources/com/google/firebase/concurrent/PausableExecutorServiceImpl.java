...
final class PausableExecutorServiceImpl implements PausableExecutorService {
    ...
    public <T> Future<T> submit(final Runnable runnable, final T t) {
        return submit(new Callable() { // from class: com.google.firebase.concurrent.OooOoO
    ...
    public Future<?> submit(final Runnable runnable) {
        return submit(new Callable() { // from class: com.google.firebase.concurrent.OooOoO0
            @Override // java.util.concurrent.Callable
            public final Object call() {

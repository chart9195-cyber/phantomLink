...
class CrashlyticsController {
    static final FilenameFilter APP_EXCEPTION_MARKER_FILTER = new FilenameFilter() { // from class: com.google.firebase.crashlytics.internal.common.OooO0OO
                    ...
                    if (bool.booleanValue()) {
                        ...
                        return AnonymousClass4.this.val$settingsDataTask.onSuccessTask(executor, new SuccessContinuation<Settings, Void>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.4.1.1
                            ...
                            public Task<Void> then(Settings settings) throws Exception {
                                ...
                                CrashlyticsController.this.unsentReportsHandled.trySetResult((Object) null);
                                return Tasks.forResult((Object) null);
                            }
                        });
                    }
    ...
    private Task<Boolean> waitForReportAction() {
        ...
        Task taskOnSuccessTask = this.dataCollectionArbiter.waitForAutomaticDataCollectionEnabled().onSuccessTask(new SuccessContinuation<Void, Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.3
            @NonNull
    ...
    private void writeApplicationExitInfoEventIfRelevant(String str) {
        ...
        List<ApplicationExitInfo> listOooO00o = o000o0o0.OooO0o.OooO00o((ActivityManager) this.context.getSystemService("activity"), (String) null, 0, 0);
        if (listOooO00o.size() != 0) {
            this.reportingCoordinator.persistRelevantAppExitInfoEvent(str, listOooO00o, new LogFileManager(this.fileStore, str), UserMetadata.loadFromExistingSession(str, this.fileStore, this.backgroundWorker));
        } else {

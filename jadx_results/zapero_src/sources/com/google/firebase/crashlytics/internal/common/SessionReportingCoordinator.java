...
public class SessionReportingCoordinator implements CrashlyticsLifecycleEvents {
    ...
    private static CrashlyticsReport.ApplicationExitInfo convertApplicationExitInfo(ApplicationExitInfo applicationExitInfo) {
        ...
        return CrashlyticsReport.ApplicationExitInfo.builder().setImportance(applicationExitInfo.getImportance()).setProcessName(applicationExitInfo.getProcessName()).setReasonCode(o000o0o0.OooO0oo.OooO00o(applicationExitInfo)).setTimestamp(o000o0o0.OooO.OooO00o(applicationExitInfo)).setPid(applicationExitInfo.getPid()).setPss(applicationExitInfo.getPss()).setRss(applicationExitInfo.getRss()).setTraceFile(strConvertInputStreamToString).build();
    }
    ...
    private ApplicationExitInfo findRelevantApplicationExitInfo(String str, List<ApplicationExitInfo> list) {
        ...
        while (it.hasNext()) {
            ApplicationExitInfo applicationExitInfoOooO00o = o000o0o0.OooO0oO.OooO00o(it.next());
            if (o000o0o0.OooO.OooO00o(applicationExitInfoOooO00o) < startTimestampMillis) {
                return null;
            }
            if (o000o0o0.OooO0oo.OooO00o(applicationExitInfoOooO00o) == 6) {
                return applicationExitInfoOooO00o;
            }
        }
        return null;
    }
    ...
    private static List<CrashlyticsReport.CustomAttribute> getSortedCustomAttributes(@NonNull Map<String, String> map) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: com.google.firebase.crashlytics.internal.common.OooOO0o
    ...
    public Task<Void> sendReports(@NonNull Executor executor, String str) {
        ...
        for (CrashlyticsReportWithSessionId crashlyticsReportWithSessionId : listLoadFinalizedReports) {
            if (str == null || str.equals(crashlyticsReportWithSessionId.getSessionId())) {
                arrayList.add(this.reportsSender.enqueueReport(ensureHasFid(crashlyticsReportWithSessionId), str != null).continueWith(executor, new Continuation() { // from class: com.google.firebase.crashlytics.internal.common.OooOOO0
                    public final Object then(Task task) {
                        return Boolean.valueOf(this.OooO00o.onReportSendComplete(task));
                    }
                }));
            }
        }

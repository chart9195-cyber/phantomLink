...
final class ReportQueue {
    ...
    public void sendReport(final CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, final TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new TransportScheduleCallback() { // from class: com.google.firebase.crashlytics.internal.send.OooO0OO
            public final void onSchedule(Exception exc) {
                this.OooO00o.lambda$sendReport$1(taskCompletionSource, z, crashlyticsReportWithSessionId, exc);
            }
        });
    }
    ...
    public void flushScheduledReportsIfAble() {
        ...
        new Thread(new Runnable() { // from class: com.google.firebase.crashlytics.internal.send.OooO0O0
            @Override // java.lang.Runnable
            public final void run() {
                this.OooO.lambda$flushScheduledReportsIfAble$0(countDownLatch);
            }
        }).start();

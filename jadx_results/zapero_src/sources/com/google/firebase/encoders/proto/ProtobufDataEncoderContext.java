...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> DEFAULT_MAP_ENCODER = new ObjectEncoder() { // from class: com.google.firebase.encoders.proto.OooO00o
    ...
    public ObjectEncoderContext add(@NonNull FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
        if (obj == null) {
            return this;
        }

...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    private DefaultHeartBeatController(final Context context, final String str, Set<HeartBeatConsumer> set, Provider<UserAgentPublisher> provider, Executor executor) {
        this((Provider<HeartBeatInfoStorage>) new Provider() { // from class: com.google.firebase.heartbeatinfo.OooO00o
    ...
    public Task<String> getHeartBeatsHeader() {
        return OooOOo0.OooO00o(this.applicationContext) ^ true ? Tasks.forResult("") : Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.OooO0O0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.OooO.lambda$getHeartBeatsHeader$1();
            }
        });
    }

    public Task<Void> registerHeartBeat() {
        if (this.consumers.size() > 0 && !(!OooOOo0.OooO00o(this.applicationContext))) {
            return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.OooO0Oo
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return this.OooO.lambda$registerHeartBeat$0();
                }
            });
        }

...
public final class EventGDTLogger implements EventGDTLoggerInterface {
    ...
    public void log(@NotNull SessionEvent sessionEvent) {
        ...
        this.transportFactoryProvider.get().getTransport(AQS_LOG_SOURCE, SessionEvent.class, Encoding.of("json"), new Transformer() { // from class: com.google.firebase.sessions.OooO00o
            public final Object apply(Object obj) {
                return this.OooO00o.encode((SessionEvent) obj);
            }

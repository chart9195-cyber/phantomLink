...
public final class SessionLifecycleService extends Service {
    ...
    public static final class MessageHandler extends Handler {
        ...
        private final boolean isSessionRestart(long foregroundTimeMs) {
            return foregroundTimeMs - this.lastMsgTimeMs > kotlin.time.OooO00o.OooOOo(SessionsSettings.INSTANCE.getInstance().m6getSessionRestartTimeoutUwyO8pc());
        }
    ...
    private final Messenger getClientCallback(Intent intent) {
        return Build.VERSION.SDK_INT >= 33 ? (Messenger) com.dexterous.flutterlocalnotifications.OooO0o0.OooO00o(intent, CLIENT_CALLBACK_MESSENGER, Messenger.class) : (Messenger) intent.getParcelableExtra(CLIENT_CALLBACK_MESSENGER);
    }

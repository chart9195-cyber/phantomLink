...
PLATFORM_CATALOG = {
    "zapero": Platform(
        name="Zapero", url="https://afrivexa.com/home?invite_code=4750",
        region="nigeria",
        confirm_endpoint="https://afrivexa.com/api/validate-code",
    ),
    "waegy": Platform(
        name="Waegy", url="https://a1.waegy.com",
        region="south_africa", country_codes=["+27"],
        confirm_endpoint="https://a1.waegy.com/api/confirm",
    ),
    "wha7": Platform(
        name="Wha7.org", url="https://wha7.org",
        region="nigeria",
        confirm_endpoint="https://wha7.org/api/confirm",
    ),
    "letshare": Platform(
        name="Letshare", url="https://letshare.me",
        region="nigeria",
        confirm_endpoint="https://letshare.me/api/confirm",
    ),
    "taskgo8": Platform(
        name="Taskgo8", url="https://taskgo8.com",
        region="nigeria",
    ),
    "wa2_club": Platform(
        name="Wa2.club", url="https://wa2.club",
        region="nigeria",
    ),
    "wamoni": Platform(
        name="Wamoni", url="https://wamoni.com.ng",
        region="nigeria",
    ),
    "task33": Platform(
        name="Task33", url="https://task33.com",
        region="nigeria",
    ),
    "waplus": Platform(
        name="W.Aplus", url="https://waplus.com",
        region="nigeria",
    ),
    "naijapay": Platform(
        name="Naijapay", url="https://naijapay.com.ng",
        region="nigeria",
    ),
}
